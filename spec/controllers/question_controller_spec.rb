...
RSpec.describe QuestionController, type: :controller do
  let(:my_question) do Question.create(id: 1, title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: false)
  end
  ...
  describe "GET #index" do
    ...
    it "assigns my my_question to @question" do
      get :index
